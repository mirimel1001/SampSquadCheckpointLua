...
local typeStyle = {
	{ -- 1 - checkpoint
        text = imgui.ImColor(255, 255, 255, 255):GetVec4(), -- Text color
        rightBox = imgui.ImColor(50, 6, 96, 255):GetU32(), -- Right stripe color
        mainBox = {
            imgui.ImColor(82, 10, 161, 100):GetU32(), -- left top
            imgui.ImColor(82, 10, 161, 200):GetU32(), -- right top
            imgui.ImColor(82, 10, 161, 200):GetU32(), -- left button
            imgui.ImColor(82, 10, 161, 100):GetU32(), -- right button
        }
    },
	{ -- 2 - save message
		text = imgui.ImColor(255, 255, 255, 255):GetVec4(),
		rightBox = imgui.ImColor(10, 41, 10, 255):GetU32(),
		mainBox = {
			imgui.ImColor(30, 123, 30, 170):GetU32(), -- left top
			imgui.ImColor(30, 123, 30, 235):GetU32(), -- right top
			imgui.ImColor(30, 123, 30, 235):GetU32(), -- left button
			imgui.ImColor(30, 123, 30, 170):GetU32(), -- right button
		}
	},
	{ -- 3 - info message blue
		text = imgui.ImColor(255, 255, 255, 255):GetVec4(),
